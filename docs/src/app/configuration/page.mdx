...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>restoreInitialSave</code></td><td><code>--restore-initial-save</code></td><td>boolean</td></tr>
    <tr><td><code>restorePeriodicSave</code></td><td><code>--restore-periodic-save</code></td><td>boolean</td></tr>
    <tr><td><code>restoreCloseSave</code></td><td><code>--restore-close-save</code></td><td>boolean</td></tr>
    <tr><td><code>restorePeriodicSaveIntervalMs</code></td><td><code>--restore-periodic-save-interval-ms</code></td><td>integer</td></tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_HOME</code></td><td>Relocate agent-browser-owned config, state, browser downloads, temporary artifacts, and daemon files. Useful when the OS home is read-only in a sandbox.</td><td>writable <code>~/.agent-browser</code>, otherwise a short per-user temp directory</td></tr>
    ...
    <tr><td><code>AGENT_BROWSER_DEFAULT_TIMEOUT</code></td><td>Default standard-operation timeout and navigation override in ms. Navigation receives a matching transport budget; keep below 30000 for other slow operations to avoid IPC timeouts.</td><td><code>25000</code></td></tr>
    ...
    <tr><td><code>AGENT_BROWSER_RESTORE_INITIAL_SAVE</code></td><td>Enable the one-time post-launch save after about two seconds.</td><td><code>true</code></td></tr>
    <tr><td><code>AGENT_BROWSER_RESTORE_PERIODIC_SAVE</code></td><td>Enable periodic saves while the browser remains open.</td><td><code>true</code></td></tr>
    <tr><td><code>AGENT_BROWSER_RESTORE_CLOSE_SAVE</code></td><td>Enable saves before close, daemon shutdown, and relaunch.</td><td><code>true</code></td></tr>
    <tr><td><code>AGENT_BROWSER_AUTOSAVE_INTERVAL_MS</code></td><td>Minimum ms between periodic saves. <code>0</code> disables only the periodic stage.</td><td><code>30000</code></td></tr>
    ...
    <tr><td><code>AGENT_BROWSER_SOCKET_DIR</code></td><td>Advanced override for daemon socket files. Takes precedence over <code>AGENT_BROWSER_HOME</code>.</td><td>runtime dir or agent-browser home</td></tr>
